...
public class Dynamic_Programming extends JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        if (evt.getSource().equals(jButton1)) {
            ...
            int ans = dpAlgo.binomial(numbers[0], numbers[1]);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {
        if (evt.getSource().equals(jButton2)) {
            XYSeries plot = new XYSeries("Bin");
            for (int i = 1; i <= 40000; i *= 2) {
                long t1 = System.nanoTime();
                dpAlgo.binomial(i, i/2);
                long t2 = System.nanoTime();
                plot.add(i, t2 - t1);
            }
            XYSeriesCollection data = new XYSeriesCollection();
            data.addSeries(plot);
            JFreeChart chart = ChartFactory.createXYLineChart("Binomial Co-efficient",
                    "N", "Time (ns)", data, PlotOrientation.VERTICAL,
                    true, true, false);
